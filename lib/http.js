...
class HTTP extends Server {
  ...
  init() {
    ...
    this.on('listening', (address) => {
      this.logger.info('DBServer HTTP server listening on %s (port=%d).',
  ...
  initRouter() {
    ...
    this.get('/event', async (req, res) => {
      ...
      // Return a list of strings, the event names
    });

    // Get event info
    this.get('/event/:eventId', async (req, res) => {
    ...
    this.get('/user/:nick/:server', async (req, res) => {
      // Get the users info along with the keys that they
      // have registered
    });
    ...
    this.get('/user/address/:address', async (req, res) => {
