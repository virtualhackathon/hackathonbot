...
class AdminHTTP extends Server {
  ...
  initRouter() {
    ...
    this.put('/event', async (req, res) => {
      ...
      const start = valid.uint('start', undefined);
      const end = valid.uint('end', undefined);
      const ircUri = valid.str('ircUri', undefined);
      const message = valid.str('message', undefined);
      const open = valid.bool('open', undefined);
      const btcFee = valid.str('btcFee', undefined);
      const hnsFee = valid.str('hnsFee', undefined);
